...
# ==========================
$RepoName = "Artifactory"
$RepoSource = "https://prod.artifactory.nfcu.net/artifactory/api/nuget/cicd-md-powershell-virtual"
$RepoPublish = "https://prod.artifactory.nfcu.net/artifactory/api/nuget/cicd-md-powershell-virtual"
...
# PowerShell Repository Configuration for All Users
# ==========================
Write-Host "Configuring PowerShell repositories..."
...
# Register Artifactory Repository
Write-Host "Registering PowerShell Repository '$RepoName'..."
Register-PSRepository -Name "$RepoName" -SourceLocation "$RepoSource" -PublishLocation "$RepoPublish" -InstallationPolicy Trusted
Write-Host "PowerShell Repository '$RepoName' has been registered."
"@
