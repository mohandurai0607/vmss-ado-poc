...
# $pythonZipUrl = "$jfrogBaseUrl/$pythonVersion/windows/python-$pythonVersion.zip"
...
# ============================
Write-Host "Refreshing current session environment variables..."
